...
Page({
  ...
  initUserData(item) {
    ...
    item.baseInfo={
      ...
      location: condition.region && condition.region.length ? JSON.parse(condition.region)[1] : '',
      profession:condition.profession && condition.profession.length ? JSON.parse(condition.profession)[1] : '',
      ...
      nativeRegion: condition.nativeRegion && condition.nativeRegion.length?JSON.parse(condition.nativeRegion)[0]+JSON.parse(condition.nativeRegion)[1] : '',
    ...
    item.metaInfo = {
      ...
      location: condition2.region && condition2.region.length ? JSON.parse(condition2.region)[1] : '',
